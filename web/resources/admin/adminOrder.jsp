        ...
        <div class="layui-col-md10">
          <fieldset class="layui-elem-field">
            <legend>订单查询</legend>
              ...
              <button class="layui-btn layui-btn-normal" style="margin: 0px 10px"><i class="layui-icon layui-icon-search"></i>查询</button>
          </fieldset>
        </div>
      </div>
  ...
  layui.use('table', function(){
    ...
    table.render({
      ...
      ,cols: [[ //表头
        ...
        ,{field: 'shopdate', title: '购买时间',align: 'center' , width: 177}
